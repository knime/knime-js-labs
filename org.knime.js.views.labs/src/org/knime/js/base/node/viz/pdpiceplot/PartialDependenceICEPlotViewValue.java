...
public class PartialDependenceICEPlotViewValue extends JSONViewContent {
   ...
   public void setSubscribeToFilters(final boolean subscribeToFilters) {
	...
	/**
	 * @param image as an SVG string to set the internal string representation of the
	 *            image
	 */
	...
	public boolean equals(final Object obj) {
		...
		return new EqualsBuilder()
		        .append(m_showPDP, other.m_showPDP)
		        .append(m_PDPColor, other.m_PDPColor)
				.append(m_PDPLineWeight, other.m_PDPLineWeight)
				.append(m_showPDPMargin, other.m_showPDPMargin)
				.append(m_PDPMarginType, other.m_PDPMarginType)
				.append(m_PDPMarginMultiplier, other.m_PDPMarginMultiplier)
				.append(m_PDPMarginAlphaVal, other.m_PDPMarginAlphaVal)
				.append(m_showICE, other.m_showICE)
				.append(m_ICEColor, other.m_ICEColor)
				.append(m_ICEWeight, other.m_ICEWeight)
				.append(m_ICEAlphaVal, other.m_ICEAlphaVal)
				.append(m_showDataPoints, other.m_showDataPoints)
				.append(m_dataPointColor, other.m_dataPointColor)
				.append(m_dataPointWeight, other.m_dataPointWeight)
				.append(m_dataPointAlphaVal, other.m_dataPointAlphaVal)
				...
				.append(m_yAxisMargin, other.m_yAxisMargin)
				...
				.append(m_subscribeToFilters, other.m_subscribeToFilters)
				.append(m_showStaticLine, other.m_showStaticLine)
				.append(m_staticLineColor, other.m_staticLineColor)
				.append(m_staticLineWeight, other.m_staticLineWeight)
				...
				.append(m_selected, other.m_selected)
				.isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder()
		        .append(m_showPDP)
		        .append(m_PDPColor)
		        .append(m_PDPLineWeight)
				.append(m_showPDPMargin)
				.append(m_PDPMarginType)
				.append(m_PDPMarginMultiplier)
				.append(m_PDPMarginAlphaVal)
				.append(m_showICE)
				.append(m_ICEColor)
				.append(m_ICEWeight)
				.append(m_ICEAlphaVal)
                .append(m_showDataPoints)
                .append(m_dataPointColor)
                .append(m_dataPointWeight)
                .append(m_dataPointAlphaVal)
				.append(m_xAxisLabel)
				.append(m_yAxisLabel)
				.append(m_xAxisMin)
				.append(m_xAxisMax)
				.append(m_yAxisMin)
				.append(m_yAxisMax)
                .append(m_yAxisMargin)
				.append(m_chartTitle)
				.append(m_chartSubtitle)
				.append(m_showGrid)
                .append(m_subscribeToSelection)
                .append(m_publishSelection)
                .append(m_subscribeToFilters)
				.append(m_showStaticLine)
				.append(m_staticLineColor)
				.append(m_staticLineWeight)
				.append(m_staticLineYValue)
				.append(m_enableMouseCrosshair)
