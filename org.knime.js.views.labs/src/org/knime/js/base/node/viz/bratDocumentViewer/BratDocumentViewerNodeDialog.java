 ...
 */
public class BratDocumentViewerNodeDialog extends NodeDialogPane {

    private static final int TEXT_FIELD_SIZE = DialogUtil.DEF_TEXTFIELD_WIDTH;

    private BratDocumentViewerConfig m_config;
    ...
    private JCheckBox m_displayRowColorsCheckBox;
    private JCheckBox m_displayColumnHeadersCheckBox;
    private JCheckBox m_displayFullscreenButtonCheckBox;
    private JTextField m_titleField;
    private JTextField m_subtitleField;
    private DataColumnSpecFilterPanel m_columnFilterPanel;
    private JCheckBox m_useNumColsCheckBox;
    private JCheckBox m_useColWidthCheckBox;
    private DialogComponentNumber m_numColsSpinner;
    private DialogComponentNumber m_colWidthSpinner;
    ...
    private JCheckBox m_enableShowAllCheckBox;
    private JCheckBox m_enableJumpToPageCheckBox;
    ...
    private DialogComponentDateTimeOptions m_dateTimeFormats;
    private JCheckBox m_enableGlobalNumberFormatCheckbox;
    private DialogComponentNumber m_globalNumberFormatDecimalSpinner;
    private JCheckBox m_displayMissingValueAsQuestionMark;

    // warnings
    private Component m_whitespace;
    private JLabel m_numColWarning;
    private JLabel m_colWidthWarning;
    ...
    BratDocumentViewerNodeDialog() {
        ...
        m_useNumColsCheckBox = new JCheckBox("Fixed number of tiles per row (" + BratDocumentViewerConfig.MIN_NUM_COLS + " - "
            + BratDocumentViewerConfig.MAX_NUM_COLS + ")");
        m_useColWidthCheckBox = new JCheckBox(
            "Fixed tile width (" + BratDocumentViewerConfig.MIN_COL_WIDTH + " - " + BratDocumentViewerConfig.MAX_COL_WIDTH + "px)");
        m_numColsSpinner =
            new DialogComponentNumber(new SettingsModelIntegerBounded(BratDocumentViewerConfig.CFG_NUM_COLS, BratDocumentViewerConfig.DEFAULT_NUM_COLS,
                BratDocumentViewerConfig.MIN_NUM_COLS, BratDocumentViewerConfig.MAX_NUM_COLS), "", 1, TEXT_FIELD_SIZE, null, true, null);
        m_colWidthSpinner = new DialogComponentNumber(new SettingsModelIntegerBounded(BratDocumentViewerConfig.CFG_COL_WIDTH,
            BratDocumentViewerConfig.DEFAULT_COL_WIDTH, BratDocumentViewerConfig.MIN_COL_WIDTH, BratDocumentViewerConfig.MAX_COL_WIDTH), "", 1,
    ...
    private void checkRowsAndPage() {
        ...
        if (numCols > initPageSize) {
            ...
            if (numCols <= BratDocumentViewerConfig.MAX_NUM_COLS && numCols >= BratDocumentViewerConfig.MIN_NUM_COLS) {
