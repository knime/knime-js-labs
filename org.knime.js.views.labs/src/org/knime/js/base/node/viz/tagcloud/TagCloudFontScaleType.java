 ...
 */
@JsonAutoDetect
public enum TagCloudFontScaleType {
    ...
    private static Map<String, TagCloudFontScaleType> namesMap = new HashMap<String, TagCloudFontScaleType>(2);
     ...
     */
    @JsonCreator
    public static TagCloudFontScaleType forValue(final String value) {
    ...
    public String toValue() {
        for (Entry<String, TagCloudFontScaleType> entry : namesMap.entrySet()) {
