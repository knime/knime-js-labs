...
public class RowSelectorRepresentation extends JSONViewContent {

    private JSONDataTable m_table;

    /** Default constructor for bean initialization. */
    public RowSelectorRepresentation() {
        // do nothing
    }
     ...
     */
    public RowSelectorRepresentation(final JSONDataTable table) {
        setTable(table);
    }
