...
public final class OPTICSAssignerNodeFactory extends NodeFactory<OPTICSAssignerNodeModel> implements
     ...
     */
    @Override
    public OPTICSAssignerNodeModel createNodeModel() {
        return new OPTICSAssignerNodeModel();
    }
     ...
     */
    @Override
    public NodeView<OPTICSAssignerNodeModel> createNodeView(final int viewIndex,
        final OPTICSAssignerNodeModel nodeModel) {
        throw new RuntimeException("no view defined");
    }
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new OPTICSAssignerNodeDialog();
    }
